...
@Model public class DataGeneration
{
  ...
  @Transient public var includeEarlyAccessSpecies = false
...
{
  public static let container = try! ModelContainer(for: schema, configurations: [.init(isStoredInMemoryOnly: DataGenerationOptions.inMemoryPersistence)])

...
// MARK: - BackyardViewportContentKey
...
struct BackyardViewportLayout: Layout
{
  ...
  func placeSubviews(in bounds: CGRect, proposal: ProposedViewSize, subviews: Subviews, cache: inout Void)
  {
    ...
    {
      let content = subview[BackyardViewportContentKey.self]
      categorizedSubviews[content, default: []].append(subview)
    }
    ...
    for (isLeading, sideSubviews) in [
      (true, categorizedSubviews[.plant(.leading), default: []]),
